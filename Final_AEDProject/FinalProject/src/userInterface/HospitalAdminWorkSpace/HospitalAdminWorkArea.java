...
public class HospitalAdminWorkArea extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        manageOrganizationBtn.setBackground(new java.awt.Color(255, 204, 204));
        manageOrganizationBtn.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        manageOrganizationBtn.setText("Manage Organization");
        manageOrganizationBtn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        add(manageOrganizationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 570, 40));

        manageEmployeeBtn.setBackground(new java.awt.Color(255, 204, 204));
        manageEmployeeBtn.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        manageEmployeeBtn.setText("Manage People");
        manageEmployeeBtn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        manageEmployeeBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                manageEmployeeBtnActionPerformed(evt);
            }
        });
        add(manageEmployeeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 570, 40));
        ...
        manageUserJBtn.setBackground(new java.awt.Color(255, 204, 204));
        manageUserJBtn.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        manageUserJBtn.setText("Manage User");
        manageUserJBtn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        manageUserJBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                manageUserJBtnActionPerformed(evt);
            }
        });
        add(manageUserJBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 570, 40));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userInterface/Images/IMAGES/hospital_AED.png"))); // NOI18N
        jLabel3.setText("jLabel3");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, 810, 330));
